...
- (NSString *)creatThumbnailWithBackgroundImage:(UIImage *)backgroundImage colorType:(EATimerColorType )colorType thumbnailSize:(CGSize )size cornerRadius:(NSInteger )cornerRadius screenType:(EAScreenType )screenType;
