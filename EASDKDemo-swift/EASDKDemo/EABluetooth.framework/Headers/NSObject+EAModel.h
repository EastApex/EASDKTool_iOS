 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `EAModel` protocol for custom methods.
 ...
 Sample Code:
     ...
     ********************** json convertor *********************
 @code
     @interface EAAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation EAAuthor
     @end
 
     @interface EABook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) EAAuthor *author;
     @end
     @implementation EABook
     @end
    
     int main() {
         // create model from json
         EABook *book = [EABook ea_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book ea_modelToJSONString];
 ...
 @code
     @interface EAShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation EAShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self ea_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self ea_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self ea_modelCopy]; }
     - (NSUInteger)hash { return [self ea_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self ea_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (EAModel)
 ...
 */
+ (nullable instancetype)ea_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)ea_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)ea_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)ea_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)ea_modelToJSONObject;
 ...
 */
- (nullable NSData *)ea_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)ea_modelToJSONString;
 ...
 */
- (void)ea_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)ea_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)ea_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (EAModel)
 ...
 */
+ (nullable NSDictionary *)ea_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<EAModel>' to your class header.
 */
@protocol EAModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
  @code
        @class EAShadow, EABorder, EAAttachment;
 
        @interface EAAttributes
        @property NSString *name;
        ...
        @implementation EAAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [EAShadow class],
                     @"borders" : EABorder.class,
...
/**
 ...
 Example:
 @code
        @class EACircle, EARectangle, EALine;
 
        @implementation EAShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [EACircle class];
            } else if (dictionary[@"width"] != nil) {
                return [EARectangle class];
